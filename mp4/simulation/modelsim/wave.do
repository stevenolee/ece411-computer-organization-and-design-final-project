...
add wave -noupdate -radix hexadecimal /mp3_tb/dut/i_cache/cache_data_o
...
WaveRestoreCursors {{Cursor 1} {705000 ps} 0} {{Cursor 2} {3834080 ps} 0}
...
update
WaveRestoreZoom {333224 ps} {1383224 ps}
